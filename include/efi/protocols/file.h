...
struct file {
    ...
    status (*open_ex)(file *proto, file **new_handle, c16 *file_name, u64 open_mode, u64 attributes, file_io_token *token);
    status (*read_ex)(file *proto, file_io_token *token);
    status (*write_ex)(file *proto, file_io_token *token);
    status (*flush_ex)(file *proto, file_io_token *token);
};
